...
def brand_template_context(*, version: str | None = None, base_url: str | None = None) -> dict[str, Any]:
    ...
    return {
        ...
        "download_setup_asset_url": f"{GITHUB_URL}/releases/download/v{ver}/DesklineSetup-{ver}.exe",
        "download_sha256_url": f"{GITHUB_URL}/releases/download/v{ver}/SHA256SUMS.txt",
        "download_extension_url": f"{GITHUB_URL}/releases/download/v{ver}/Deskline-Extension-{ver}.zip",
